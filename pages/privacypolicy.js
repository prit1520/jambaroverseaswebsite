...
export default function privacypolicy() {
  ...
  return (
    <Layout>
      <NextSeo
        title="Privacy Policy | JambarOverseas"
        description="Your privacy is important to us. It is JambarOverseas Inc.'s policy to respect your privacy regarding any information we may collect from you across our website..."
      />
      <div className={classes.root}>
        ...
        <div className={classes.content}>
          ...
          <p>This policy is effective as of 6 January 2025.</p>
        </div>
      </div>
    </Layout>
  );
